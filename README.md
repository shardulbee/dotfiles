...
- Pushing `main` deploys Sharchy, then TurboGadget via [GitHub Actions](.github/workflows/deploy.yml). Host bootstrap: [NixOS](config/sharchy-deploy.nix), [macOS](config/turbogadget-deploy.nix).
